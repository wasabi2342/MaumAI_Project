...
extension ResponsiveExtension on num {
  ...
  // Width-based calculation (for horizontal dimensions)
  double get w => ((this * _width) / FIGMA_DESIGN_WIDTH);

  // Height-based calculation (for vertical dimensions) - FIXED!
  double get h => ((this * _height) / FIGMA_DESIGN_HEIGHT);

  // Font size (width-based for consistency across devices)
